...
## Load data
df = pd.read_csv("D:/下载/n-beats-master新/n-beats-master/examples/data/shanghai.csv")
...
Shanghai_df = SIR_data[SIR_data['date'] < datetime.datetime(2020,5, 25)]
...
print(estimation_df)
# 2.3
test = SIR_data[SIR_data['date'] < datetime.datetime(2020, 5, 25)]
...
# result.to_csv('D:/下载/n-beats-master新/n-beats-master/examples/data/pre_shanghai1.csv')
